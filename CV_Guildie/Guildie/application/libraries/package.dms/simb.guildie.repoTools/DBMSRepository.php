<?php
    ...
    //require_once(defined('BASEPATH')."/IIterator.php");

	//$CI =& get_instance();
	//$CI->load->library('package.dms/simb.guildie.repoTools/IIterator');

    require_once("application/libraries/package.dms/simb.guildie.dll/IIterator.php");

	class DBMSRepository extends CI_loader implements IIterator  {
